...
const READ_MASK = [
  "name","title","storeCode","languageCode","profile",
  "phoneNumbers","websiteUri","categories","storefrontAddress",
  "latlng","openInfo","regularHours","specialHours","moreHours",
  "serviceArea","serviceItems","adWordsLocationExtensions",
  "labels","relationshipData",
].join(",");
