...
import { Mail, KeyRound, Eye, EyeOff, ShieldCheck, User } from "lucide-react";
      ...
      <div className="w-full max-w-[420px]">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1
            ...
            style={{ color: isDark ? "#fff" : "#0f172a", letterSpacing: "-0.04em", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif" }}
          >
            Create Admin Account
          </h1>
          <p className="text-sm" style={{ color: isDark ? "#64748b" : "#64748b" }}>
            Set up your Croissix Console access
          </p>
        </div>
        ...
        >
          <Field label="Full Name" isDark={isDark}>
            <FieldInput
              ...
              placeholder="Admin Name" autoComplete="name" isDark={isDark}
          ...
          <Field label="Password" isDark={isDark}>
            <FieldInput
              ...
              placeholder="Min. 6 characters" autoComplete="new-password" isDark={isDark}
  ...
  return (
    ...
    >
      ...
      <input
        ...
        style={{ color: isDark ? "#fff" : "#0f172a", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif" }}
      />
